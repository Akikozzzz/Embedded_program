...
<pre>`sudo apt-get install git cmake build-essential libi2c-dev libpthread-stubs0-dev -y`</pre>

## 4.3	Cloning and construction projects
Clone the project source
<pre>git clone https://github.com/Akikozzzz/Embedded_program.git
cd Embedded_program/team6_Project</pre>
